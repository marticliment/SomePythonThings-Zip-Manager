...
class QFramelessDialog(QFramelessWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.title.setStyleSheet("color: white;font-size: 16pt;padding: 30px; padding-bottom: 5px;")
        l.addWidget(self.title)
        self.body = QLabel("This is the body. Here comes the warning")
        self.body.setStyleSheet("color: white;font-size: 10pt;font-weight: light;font-family: \"Segoe UI Variable Display\";padding: 30px; padding-top: 5px;")
